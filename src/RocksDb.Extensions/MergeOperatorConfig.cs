...
internal class MergeOperatorConfig
{
        ...
        out bool success)
    {
        ...
        try
        {
            ...
            var (mergeSuccess, result) = mergeOperator.FullMerge(existing, operandSpan);
        ...
        {
            // RocksDB callback context doesn't allow exceptions to propagate
            success = false;
            return Array.Empty<byte>();
        }
        finally
        ...
        out bool success)
    {
        ...
        try
        {
            ...
            var operandSpan = operandArray.AsSpan(0, operands.Count);
            var (mergeSuccess, result) = mergeOperator.PartialMerge(operandSpan);
